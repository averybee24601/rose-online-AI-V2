...
enum StatType {
    STAT_TYPE_IS_SUMMON = 1,
    STAT_TYPE_GENDER = 2,
    STAT_TYPE_BIRTH_STONE = 3,
    STAT_TYPE_JOB = 4,
    STAT_TYPE_UNION = 5,
    STAT_TYPE_RANKING = 6,
    STAT_TYPE_REPUTATION = 7,
    STAT_TYPE_FACE = 8,
    STAT_TYPE_HAIR = 9,
    STAT_TYPE_STRENGTH = 10,
    STAT_TYPE_DEXTERITY = 11,
    STAT_TYPE_INTELLIGENCE = 12,
    STAT_TYPE_CONCENTRATION = 13,
    STAT_TYPE_CHARM = 14,
    STAT_TYPE_SENSIBILITY = 15,
    STAT_TYPE_HP = 16,
    STAT_TYPE_MP = 17,
    STAT_TYPE_ATTACK_POWER = 18,
    STAT_TYPE_DEFENSE = 19,
    STAT_TYPE_ACCURACY = 20,
    STAT_TYPE_MAGIC_RESISTANCE = 21,
    STAT_TYPE_DODGE = 22,
    STAT_TYPE_MOVE_SPEED = 23,
    STAT_TYPE_ATTACK_SPEED = 24,
    STAT_TYPE_MAX_WEIGHT = 25,
    STAT_TYPE_CRITICAL = 26,
    STAT_TYPE_HP_RATE = 27,
    STAT_TYPE_MP_RATE = 28,
    STAT_TYPE_MP_DECREASE = 29,
    STAT_TYPE_EXP_RATE = 30,
    STAT_TYPE_LEVEL = 31,
    STAT_TYPE_STAT_POINTS = 32,
    STAT_TYPE_TENDENCY = 33,
    STAT_TYPE_PVP = 34,
    STAT_TYPE_HEAD_SIZE = 35,
    STAT_TYPE_BODY_SIZE = 36,
    STAT_TYPE_SKILL_POINTS = 37,
    STAT_TYPE_MAX_HP = 38,
    STAT_TYPE_MAX_MP = 39,
    STAT_TYPE_MONEY = 40,
    STAT_TYPE_UNARMED_ATK_POW = 41,
    STAT_TYPE_ONE_HAND_ATK_POW = 42,
    STAT_TYPE_TWO_HAND_ATK_POW = 43,
    STAT_TYPE_BOW_ATK_POW = 44,
    STAT_TYPE_GUN_ATK_POW = 45,
    STAT_TYPE_MAGIC_ATK_POW = 46,
    STAT_TYPE_CROSSBOW_ATK_POW = 47,
    STAT_TYPE_COMBAT_ATK_POW = 48,
    STAT_TYPE_BOW_ATK_SPD = 49,
    STAT_TYPE_GUN_ATK_SPD = 50,
    STAT_TYPE_COMBAT_ATK_SPD = 51,
    STAT_TYPE_MOVE_SPEED2 = 52,
    STAT_TYPE_DEFENSE2 = 53,
    STAT_TYPE_MAX_HP2 = 54,
    STAT_TYPE_MAX_MP2 = 55,
    STAT_TYPE_HP_RECOVERY = 56,
    STAT_TYPE_MP_RECOVERY = 57,
    STAT_TYPE_MAX_WEIGHT2 = 58,
    STAT_TYPE_BUY_DISCOUNT = 59,
    STAT_TYPE_SALES_PREMIUM = 60,
    STAT_TYPE_MP_SPEND_DECREASE = 61,
    STAT_TYPE_EXPAND_SUMMON_GAUGE = 62,
    STAT_TYPE_ITEM_DROP_INCREASE = 63,
    STAT_TYPE_INCREASE_SUMMON_GAUGE = 63,
    STAT_TYPE_CURRENT_PLANET = 75,
    STAT_TYPE_STAMINA = 76,
    STAT_TYPE_CLAN_POINTS = 92,
    STAT_TYPE_NO_STORAGE_CHARGE = 93,
    STAT_TYPE_EXPAND_STORAGE = 95,
    STAT_TYPE_REMODEL_SHOP = 96,
    STAT_TYPE_CART_GAUGE = 97
};
