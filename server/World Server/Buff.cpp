...
enum BuffStatus {
    BUFF_STATUS_POISON_25 = 25,
    BUFF_STATUS_POISON_50 = 50,
    BUFF_STATUS_POISON_75 = 75,
    BUFF_STATUS_POISON_100 = 100,
    BUFF_STATUS_POISON_150 = 150,
    BUFF_STATUS_POISON_300 = 300,
    BUFF_STATUS_SILENCE = 30,
    BUFF_STATUS_SLEEP = 31,
    BUFF_STATUS_STUN = 32,
    BUFF_STATUS_CANCEL_BUFF1 = 33,
    BUFF_STATUS_CANCEL_ALL = 34,
    BUFF_STATUS_ENCHANT_DAMAGE1 = 35,
    BUFF_STATUS_IM_ENCHANT_DAMAGE = 36,
    BUFF_STATUS_ENCHANT_DAMAGE2 = 37,
    BUFF_STATUS_REFLECT = 38,
    BUFF_STATUS_ATTACK_UP = 18,
    BUFF_STATUS_ATTACK_DOWN = 19,
    BUFF_STATUS_IM_ATTACK_UP = 48,
    BUFF_STATUS_DEFENSE_UP = 20,
    BUFF_STATUS_DEFENSE_DOWN1 = 21,
    BUFF_STATUS_IM_DEFENSE_UP = 49,
    BUFF_STATUS_HIT_UP = 24,
    BUFF_STATUS_HIT_DOWN = 25,
    BUFF_STATUS_IM_HIT_UP = 51,
    BUFF_STATUS_MDEFENSE_UP = 22,
    BUFF_STATUS_MDEFENSE_DOWN = 23,
    BUFF_STATUS_IM_MDEFENSE_UP = 50,
    BUFF_STATUS_AVOID_UP = 28,
    BUFF_STATUS_AVOID_DOWN = 29,
    BUFF_STATUS_IM_AVOID_UP = 53,
    BUFF_STATUS_DASH_UP = 14,
    BUFF_STATUS_DASH_DOWN = 15,
    BUFF_STATUS_IM_DASH_UP = 46,
    BUFF_STATUS_HASTE_UP = 16,
    BUFF_STATUS_HASTE_DOWN = 17,
    BUFF_STATUS_IM_HASTE_UP = 47,
    BUFF_STATUS_CRITICAL_UP = 26,
    BUFF_STATUS_CRITICAL_DOWN = 27,
    BUFF_STATUS_IM_CRITICAL_UP = 52,
    BUFF_STATUS_MAX_HP = 12,
    BUFF_STATUS_IM_MAX_HP = 44,
    BUFF_STATUS_MAX_MP = 13,
    BUFF_STATUS_IM_MAX_MP = 45,
    BUFF_STATUS_BURN_30 = 30,
    BUFF_STATUS_BURN_60 = 60,
    BUFF_STATUS_BURN_100 = 100,
    BUFF_STATUS_BURN_150 = 150,
    BUFF_STATUS_BURN_200 = 200,
    BUFF_STATUS_BURN_300 = 300,
    BUFF_STATUS_BURN_400 = 400,
    BUFF_STATUS_STEALTH1 = 33,
    BUFF_STATUS_STEALTH_WEAKEN = 86,
    BUFF_STATUS_CLOAKING = 34,
    BUFF_STATUS_DETECT = 35,
    BUFF_STATUS_TAUNT = 56,
    BUFF_STATUS_CANCEL_DEBUFF1 = 57,
    BUFF_STATUS_STR_UP = 58,
    BUFF_STATUS_STR_DOWN = 59,
    BUFF_STATUS_DEX_UP = 60,
    BUFF_STATUS_DEX_DOWN = 61,
    BUFF_STATUS_INT_UP = 62,
    BUFF_STATUS_INT_DOWN = 63,
    BUFF_STATUS_CON_UP = 64,
    BUFF_STATUS_CON_DOWN = 65,
    BUFF_STATUS_CHA_UP = 66,
    BUFF_STATUS_CHA_DOWN = 67,
    BUFF_STATUS_SEN_UP = 68,
    BUFF_STATUS_SEN_DOWN = 69,
    BUFF_STATUS_ALL_UP = 126,
    BUFF_STATUS_ALL_DOWN = 127
};
...
bool CWorldServer::CheckABuffs( CSkills* thisskill, CCharacter* character, int intvalue,int i)
{
    ...
    {
        switch( (BuffStatus)thisskill->status[i])
        {
            case BUFF_STATUS_POISON_25:
            case BUFF_STATUS_POISON_50:
            case BUFF_STATUS_POISON_75:
            case BUFF_STATUS_POISON_100:
            case BUFF_STATUS_POISON_150:
            case BUFF_STATUS_POISON_300:
            ...
            break;
			case BUFF_STATUS_CANCEL_BUFF1:
            case BUFF_STATUS_CANCEL_ALL: // Dispell. removes all buff and debuff effects
            {
            ...
            break;
            case BUFF_STATUS_ENCHANT_DAMAGE1: //A_Extra_Damage:
            case BUFF_STATUS_IM_ENCHANT_DAMAGE: //A_GMExtra_Damage:
            case BUFF_STATUS_ENCHANT_DAMAGE2: //Valkyrie Charm:
            {
...
//                    character->Stats->ShieldDamage = thisskill->atkpower;
            ...
            break;
            case BUFF_STATUS_ATTACK_UP:
            case BUFF_STATUS_ATTACK_DOWN:
            case BUFF_STATUS_IM_ATTACK_UP:
            {
            ...
            break;
            case BUFF_STATUS_DEFENSE_UP:
            case BUFF_STATUS_DEFENSE_DOWN1:
            case BUFF_STATUS_IM_DEFENSE_UP:
            if(randv <= thisskill->success)
            {
            ...
            break;
            case BUFF_STATUS_HIT_UP:
            case BUFF_STATUS_HIT_DOWN:
            case BUFF_STATUS_IM_HIT_UP:
            if(randv <= thisskill->success)
            {
                CBValue BuffValue = GetBuffValue( thisskill, character, intvalue, i,
            ...
            break;
            case BUFF_STATUS_MDEFENSE_UP:
            case BUFF_STATUS_MDEFENSE_DOWN:
            case BUFF_STATUS_IM_MDEFENSE_UP:
            if(randv <= thisskill->success)
            {
                CBValue BuffValue = GetBuffValue( thisskill, character, intvalue, i,
            ...
            break;
            case BUFF_STATUS_AVOID_UP:
            case BUFF_STATUS_AVOID_DOWN:
            case BUFF_STATUS_IM_AVOID_UP:
            if(randv <= thisskill->success)
            {
                CBValue BuffValue = GetBuffValue( thisskill, character, intvalue, i,
            ...
            break;
            case BUFF_STATUS_DASH_UP:
            case BUFF_STATUS_DASH_DOWN:
            case BUFF_STATUS_IM_DASH_UP:
            if(randv <= thisskill->success)
            {
            ...
            break;
            case BUFF_STATUS_HASTE_UP:
            case BUFF_STATUS_HASTE_DOWN:
            case BUFF_STATUS_IM_HASTE_UP:
            if(randv <= thisskill->success)
            {
                CBValue BuffValue = GetBuffValue( thisskill, character, intvalue, i,
            ...
            break;
            case BUFF_STATUS_CRITICAL_UP:
            case BUFF_STATUS_CRITICAL_DOWN:
            case BUFF_STATUS_IM_CRITICAL_UP:
            if(randv <= thisskill->success)
            {
                CBValue BuffValue = GetBuffValue( thisskill, character, intvalue, i,
            ...
            break;
            case BUFF_STATUS_MAX_HP: // max HP up
            case BUFF_STATUS_IM_MAX_HP: // max HP up
            if(randv <= thisskill->success)
            {
                CBValue BuffValue = GetBuffValue( thisskill, character, intvalue, i,
            ...
            break;
            case BUFF_STATUS_MAX_MP:
            case BUFF_STATUS_IM_MAX_MP:
            if(randv <= thisskill->success)
            {
                CBValue BuffValue = GetBuffValue( thisskill, character, intvalue, i,
            ...
            break;
            case BUFF_STATUS_BURN_30:
            case BUFF_STATUS_BURN_60:
            case BUFF_STATUS_BURN_100:
            case BUFF_STATUS_BURN_150:
            case BUFF_STATUS_BURN_200:
            case BUFF_STATUS_BURN_300:
            case BUFF_STATUS_BURN_400:
            if(randv <= thisskill->success)
            {
            ...
            break;
            case BUFF_STATUS_STEALTH_WEAKEN:
            if(randv <= thisskill->success)
            {
            ...
            break;
            case BUFF_STATUS_CLOAKING: //Cloak
            if(randv <= thisskill->success)
            {
            ...
            break;
            case BUFF_STATUS_DETECT: //Detect
            if(randv <= thisskill->success)
            {
            ...
            break;
            case BUFF_STATUS_CANCEL_DEBUFF1:
            if(randv <= thisskill->success)
            {
            ...
            break;
            case BUFF_STATUS_STR_UP: case BUFF_STATUS_STR_DOWN:
            {
                CBValue BuffValue = GetBuffValue( thisskill, character, intvalue, i,
            ...
            break;
            case BUFF_STATUS_DEX_UP:
            case BUFF_STATUS_INT_UP:
            case BUFF_STATUS_CON_UP:
            case BUFF_STATUS_CHA_UP:
            case BUFF_STATUS_SEN_UP:
            break;
            case BUFF_STATUS_ALL_UP: case BUFF_STATUS_ALL_DOWN:
            {
                CBValue BuffValue = GetBuffValue( thisskill, character, intvalue, i,
            ...
            break;
            case BUFF_STATUS_DEX_DOWN:
            case BUFF_STATUS_INT_DOWN:
            case BUFF_STATUS_CON_DOWN:
            case BUFF_STATUS_CHA_DOWN:
            case BUFF_STATUS_SEN_DOWN:
            break;
            default:
            {
