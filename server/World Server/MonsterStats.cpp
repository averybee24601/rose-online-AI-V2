...
// Simplified monster attack power calculation function
unsigned int CMonster::CalculateMonsterAttackPower() {
    UINT attack = thisnpc->atkpower;
...
{
    return CalculateMonsterAttackPower();
}
