...
#define BUFF_MAX_HP          0x10000000 //new 1
#define BUFF_MAX_MP          0x20000000 //new
#define BUFF_DASH_UP         0x40000000 //
#define BUFF_DASH_DOWN       0x80000000 //
#define BUFF_HASTE_UP        0x00010000 //
#define BUFF_HASTE_DOWN      0x00020000 //
#define BUFF_ATTACK_UP       0x00040000 //new
#define BUFF_ATTACK_DOWN     0x00080000 //new
#define BUFF_DEFENSE_UP      0x00100000 //new
#define BUFF_DEFENSE_DOWN    0x00200000 //new
#define BUFF_MDEFENSE_UP     0x00400000 //new
#define BUFF_MDEFENSE_DOWN   0x00800000 //new
#define BUFF_HITRATE_UP      0x00000100 //new
#define BUFF_HITRATE_DOWN    0x00000200 //new cant find it xD
#define BUFF_CRITICAL_UP     0x00000400 //
#define BUFF_CRITICAL_DOWN   0x00000800 //
#define BUFF_DODGE_UP        0x00001000 //
#define BUFF_DODGE_DOWN      0x00002000 //
...
#define BUFF_DUMMY_DAMAGE    0x00000010 //
#define BUFF_LIFE_TIME       0x00000020 //
#define BUFF_REVIVE          0x40000040 // orr ...... it could be that my fix on the packet is enough and i just though it works
// thats it :):)
#define BUFF_TAUNT           0x00000080

#define BUFF_STATUS_ALL_UP	 0x00100000 //*/
