...
enum PartyReply {
    PARTY_REPLY_CANNOT_FIND_ID = 0x00,
    PARTY_REPLY_ALREADY_IN_PARTY = 0x01,
    PARTY_REPLY_INAPPROPRIATE_LEVEL = 0x07,
    PARTY_REPLY_ACCEPTED = 0x02,
    PARTY_REPLY_DECLINED = 0x04,
    PARTY_REPLY_KICKED = 0x80
};
...
void CWorldServer::Send_pakPartyReply(CPlayer* pPlayer, int source, PartyReply action)
{
