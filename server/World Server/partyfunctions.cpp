...
enum PartyLevel {
    PARTY_LEVEL_1_4 = 1,
    PARTY_LEVEL_5_9 = 5,
    PARTY_LEVEL_10_14 = 10,
    PARTY_LEVEL_15_PLUS = 15
};
...
void CParty::RefreshMax()
{
    ...
    if(PartyLevel>=PARTY_LEVEL_1_4&&PartyLevel<=4)
    {
        new_one=4;
    }

    if(PartyLevel>=PARTY_LEVEL_5_9&&PartyLevel<=9)
    {
        new_one=5;
    }

    if(PartyLevel>=PARTY_LEVEL_10_14&&PartyLevel<=14)
    {
        new_one=6;
    }

    if(PartyLevel>=PARTY_LEVEL_15_PLUS)
    {
        new_one=7;
    }
