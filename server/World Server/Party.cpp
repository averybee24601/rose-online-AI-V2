...
enum PartyAction {
    PARTY_ACTION_INVITE = 0x00,
    PARTY_ACTION_INVITE_EXISTING = 0x01,
    PARTY_ACTION_LEAVE = 0x02,
    PARTY_ACTION_GIVE_LEADER = 0x03,
    PARTY_ACTION_KICK = 0x81
};
...
bool CWorldServer::pakPartyActions( CPlayer* thisclient, CPacket* P )
{
    ...
    switch(action)
    {
        case PARTY_ACTION_INVITE://Invita a new party
        case PARTY_ACTION_INVITE_EXISTING://invite a existent party
        {
        ...
        break;
        case PARTY_ACTION_LEAVE://Leave Party
        {
            if(thisclient->Party->party==NULL)
                return true;
        ...
        break;
        case PARTY_ACTION_GIVE_LEADER: //Tomiz: Give leader New Way
        {
            if(thisclient->Party->party==NULL)
                return true;
        ...
        break;
        case PARTY_ACTION_KICK: //Kick from party
        {
