...
class CServerSocket : public CBaseSocket
{
    public:
        ...
        pthread_mutex_t             clientListMutex;   // serialize access to ClientList/ConnectedClients
    	unsigned short				port;
        ...
        void WriteHealthSnapshot(); // writes log/health.txt and appends log/health_history.log
