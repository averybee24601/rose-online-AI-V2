...
// This function builds the encryption table used to encrypt and decrypt packets.
// The table is built using a checksum of the client executable, which is used to
// generate a pseudo-random sequence of numbers. This sequence is then used to
// shuffle the encryption table, which makes it more difficult to crack the
// encryption.
